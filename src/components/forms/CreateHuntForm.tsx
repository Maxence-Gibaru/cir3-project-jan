...
export default function CreateHuntForm() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-greyBg">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4 flex flex-col justify-center items-center">
                        ...
                        <input
                            ...
                            className="mb-4 bg-gray-100 rounded-2xl border border-gray-400 shadow-xl px-4 py-2 mt-2"
                    ...
                    <div className="flex flex-col justify-center items-center">
                        <button
                            type="submit"
                            className="w-1/2 bg-darkBlueBg text-white py-2 px-4 rounded-md hover:bg-darkBlueHoverBg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                        >
                            S&apos;inscrire
                        </button>
                    </div>
