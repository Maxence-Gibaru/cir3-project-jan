...
export default function Teamnumber({Numberindice,numTeams, setNumTeams,playersPerTeam, setPlayersPerTeam,onNext}:TeamnumberProps) {
  ...
  <div className="mb-6 w-full max-w-xs mt-8">
    ...
    <input
      ...
      className="mt-2 w-full px-4 py-3 border-2 border-gray-300 rounded-lg text-center text-lg focus:outline-none focus:ring-2 focus:ring-primary"
    />
  </div>
  ...
  <div className="mb-8 w-full max-w-xs">
    ...
    >
      Joueurs maximum par équipe (optionnel si 0) :
    </label>
    <input
      id="playersPerTeam"
      type="number"
